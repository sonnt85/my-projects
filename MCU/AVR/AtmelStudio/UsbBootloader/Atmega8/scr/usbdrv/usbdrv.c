 ...
 * This Revision: $Id: usbdrv.c 155 2006-03-06 23:27:06Z cs $
 */
...
const static PROGMEM char usbDescrDevice[] = {    /* USB device descriptor */
...
const static PROGMEM char usbDescrConfig[] = {    /* USB configuration descriptor */
...
const static PROGMEM char usbDescrString0[] = {   /* language descriptor */
...
#if USB_CFG_VENDOR_NAME_LEN
const static PROGMEM int  usbDescrString1[] = {
    USB_STRING_DESCRIPTOR_HEADER(USB_CFG_VENDOR_NAME_LEN),
    USB_CFG_VENDOR_NAME
};
#endif
#if USB_CFG_DEVICE_NAME_LEN
const static PROGMEM int  usbDescrString2[] = {
