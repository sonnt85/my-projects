...
#define  disale_  1   //=0(mac dinh) chan ale luon co xung ra 1/6 chu ky may
#define  disrto_  8   //tat(1) bat(0 mac dinh) tinh nag reset chan reset 
#define  wdidle_  16    //=0(mac dinh) bo wadog van hoat dong trong idle
...
#define POF_    0x04  //co nay bat khi mat dien powerup, ko bi set khi reset..vv..xoa bang mem
#define GF1_    0x08
...
TCON Bit Registers
------------------------------------------------*/
sbit IT0  = 0x88; //=0, ngat ngoai 0 theo muc 0, =1 ngat suon xuong
sbit IE0  = 0x89;//co ngat ngoai 0
sbit IT1  = 0x8A;
sbit IE1  = 0x8B;
sbit TR0  = 0x8C;
sbit TF0  = 0x8D;
...
SCON Bit Registers
------------------------------------------------*/
sbit RI   = 0x98; //phai set ban dau moi truyen dc
sbit TI   = 0x99; //phai set moi truyen dc 
sbit RB8  = 0x9A;
sbit TB8  = 0x9B;
sbit REN  = 0x9C;
sbit SM2  = 0x9D;
